...
function script_properties()
    ...
    obs.obs_properties_add_button(g2, "btn_set_manual", "Set Manual Time", function(p, s)
        local m = obs.obs_data_get_int(s, "manual_minutes")
        local sec = obs.obs_data_get_int(s, "manual_seconds")
        set_time(m, sec)
        return true
    end)
